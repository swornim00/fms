Code for FSR:
int fsr1Pin = 0;     // the FSR and 10K pulldown are connected to a0
int fsr1Reading;     // the analog reading from the FSR resistor divider
 int fsr2Pin = 1;     // the FSR and 10K pulldown are connected to a0
int fsr2Reading;     // the analog reading from the FSR resistor divider
 ...
 Serial.print("Analog reading = ");
  ...
  } else if (fsr1Reading < 10) {
    Serial.println(" - Light touch");
  } else if (fsr1Reading < 50) {
    Serial.println(" - Light squeeze");
  } else if (fsr1Reading < 150) {
 ...
 if (fsr2Reading == 0) {
    Serial.println(" - No pressure");
  } else if (fsr2Reading < 10) {
    Serial.println(" - Light touch");
  } else if (fsr2Reading < 50) {
    Serial.println(" - Light squeeze");
  } else if (fsr2Reading < 150) {
    Serial.println(" - Medium squeeze");
  } else {
    Serial.println(" - Big squeeze");
  }
